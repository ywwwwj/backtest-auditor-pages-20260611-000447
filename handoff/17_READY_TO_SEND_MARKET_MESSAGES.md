...
Replace this placeholder before sending:

```text
SITE_URL=https://your-netlify-site.netlify.app
```

Use `SITE_URL/audit.html...` links exactly as written after replacement. Each link carries `campaign`, `channel`, `src`, and `prospect_id` so Netlify Forms can show which outreach source produced the request.
...
```text
SITE_URL/audit.html?campaign=day1_market_survey&channel=reddit&src=reddit_overfit_1&prospect_id=prospect_01
```
...
```text
SITE_URL/audit.html?campaign=day1_market_survey&channel=reddit&src=reddit_overbacktesting_1&prospect_id=prospect_05
```
...
```text
SITE_URL/audit.html?campaign=day1_market_survey&channel=quantconnect&src=qc_slippage_fees_1&prospect_id=prospect_07
```
...
```text
SITE_URL/audit.html?campaign=day1_market_survey&channel=quantconnect&src=qc_overfit_1&prospect_id=prospect_08
```
...
```text
SITE_URL/audit.html?campaign=day1_market_survey&channel=tradingview&src=tv_coinoperator_1&prospect_id=prospect_17
```
